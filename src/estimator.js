...
const covid19ImpactEstimator = (data) => {
  ...
  const availableBedsImpact = Math.trunc(0.35 * data.totalHospitalBeds) - severeCasesImpact;
  const availableBedsSevere = Math.trunc(0.35 * data.totalHospitalBeds) - severeCasesSevere;
